...
class LinkForm extends React.Component {
    ...
    render() {
        return <span>
            ...
            <input type="text" style={{ width: '80px', marginLeft: '10px', marginTop: '10px', marginBottom: '10px' }} value={this.state.issue} onChange={(e) => { this.setState({ issue: e.target.value }) }} />
